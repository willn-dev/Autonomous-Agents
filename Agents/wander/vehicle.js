class Vehicle{
  ...
  wander(){
    ...
    wanderPoint.setMag(100); //casts vel 100 pixels out. 
    ...
    let steerForce = wanderPoint.sub(this.pos);
    steerForce.setMag(this.maxForce);
    this.applyForce(steerForce);

    let displacement = 0.3;
    this.wanderTheta += random(-displacement, displacement);
